...
\todo[inline]{Is this a good enough justification? We certainly don't have a large sample size, but we do have small rates. Mike: It seems good enough to me.}
...
\begin{equation}
    \left\{ q \left( \frac{1 - a}{2}, %\frac{G_{\beta}^L + B_{\phi_n}^L }{B_{\phi_p}^U + B_{\phi_n}^L } 
    g \left[ G^L_{\beta^*}, B^U_{\phi_n}, B^U_{\phi_p} \right]
    \right),  q \left( \frac{1 + a}{2}, %\frac{G_{\beta}^U + B_{\phi_n}^U}{B_{\phi_p}^L + B_{\phi_n}^U}  \right) \right\}.
